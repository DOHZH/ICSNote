...
3. 例子：<br>![](./pic/chapter3/37.PNG)<br>rsp为栈指针<br>指针变量因为一般等于1字长，我们使用64位系统，所以指针变量为64bits<br>返回地址被压入栈中，用8字节存储，因此a4从距离指针为8的位置开始，a4p从距离指针为16的位置开始<br>![](./pic/chapter3/38.PNG)
